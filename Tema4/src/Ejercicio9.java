...
public class Ejercicio9 {
	public static void ejercicio9(){
		...
		do{		
			System.out.println("Introduce un código, para salir 00000000");
			persona = scanner.next();
			if(persona.substring(0, 3).equals("199")){//Tres primeros carácteres
		...
		if(codcorr>0){
			...
			System.out.println("Han sido leídos "+codcorr+" códigos correctos");
		}else{
			System.out.println("No se ha introducido ningún código correcto.");
		} 
	}
